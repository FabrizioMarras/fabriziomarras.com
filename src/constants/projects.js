...
export const projects = [
    {
        ...
        header: [
          { title: "The Client",
            description: "Ainsyte is a platform that leverages AI to provide personality, astrology, numerology, and metaphysical analyses, helping understanding people individual traits, strengths, weaknesses for personal growth.",
          },
          {
            title: 'The Challenge',
            description: 'Create a brand digital footprint designing logos, 2D and 3D graphics and animations for the web and social media. Develop a full-stack website with various inventories powered by Artificial Intelligence.',
          }],
        work: [
      ...
      },
    {
      ...
      header : [
        { title: "The Client",
          description: "Drop Music Official is an music event organisation based in the Netherlands and collaborate with other international organisations that shares the love for music.",
        },
        {
          title: 'The Challenge',
